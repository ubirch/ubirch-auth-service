...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "cmdtools" % "0.1.1-SNAPSHOT"
)
```### `config`
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "config" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "core" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "model" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "model-db" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "oidc-util" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "server" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools-ext" % "0.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "util" % "0.1.1-SNAPSHOT"
)
```
