...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "cmdtools" % "0.2.15"
)
```### `config`
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "model-db" % "0.2.15"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "oidc-util" % "0.2.15"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools" % "0.2.15"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools-ext" % "0.2.15"
)
```
