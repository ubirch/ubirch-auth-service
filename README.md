...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "cmdtools" % "0.1.1"
)
```### `config`
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "model-db" % "0.1.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "oidc-util" % "0.1.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools" % "0.1.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.auth" %% "test-tools-ext" % "0.1.1"
)
```
