...
val json4sV = "3.5.2"
val ubirchUserV = "0.6.5-SNAPSHOT"
...
lazy val ubirchUtilMongo = ubirchUtilG %% "mongo-utils" % "0.3.6" excludeAll(
...
lazy val ubirchUtilOidcUtils = ubirchUtilG %% "oidc-utils" % "0.4.15-SNAPSHOT" excludeAll(excludedLoggers: _*)
